...
const (
	...
	UserService_VerifyToken_FullMethodName = "/ecopoint.user.v1.UserService/VerifyToken"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ecopoint.user.v1.UserService",
	...
	Metadata: "ecopoint/user/v1/user.proto",
}
